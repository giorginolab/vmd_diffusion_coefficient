...
#
# UI generated by GUI Builder Build 146 on 2011-07-22 16:58:48 from:
...
# BEGIN USER CODE
package provide diffusion_coefficient_gui 0.2

# VMD-specific stuff
set diffusion_coefficient_gui::in_vmd [string length [info proc vmd_install_extension]]
if { $diffusion_coefficient_gui::in_vmd } {
    vmd_install_extension diffusion_coefficient diffusion_coefficient_gui::diffusion_coefficient_tk "Analysis/Diffusion Coefficient Tool"
}
...
proc diffusion_coefficient_gui::save_table {fn xl yl} {
    set fd [open $fn w]
    foreach x $xl y $yl {
	puts $fd "$x $y"
    }
    close $fd
    puts "Written data file $fn"
}
...
proc diffusion_coefficient_gui::plot_d_button_command args {
    ...
    save_table /tmp/diffusion_coefficient.[pid].dat $tlist $dlist
}
