# diffusion_coefficient_ui.tcl --
#
# UI generated by GUI Builder Build 146 on 2011-02-18 01:01:52 from:
#    /home/toni/work/vmd-utils/vmd_diffusion_coefficient/diffusion_coefficient.ui
...
#
proc diffusion_coefficient::ui {root args} {
    ...
    variable _entry_1 [entry $BASE._entry_1 \
	    ...
	    -textvariable "diffusion_coefficient::selection" \
    ...
    variable _entry_2 [entry $BASE._entry_2 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::dt" \
    ...
    variable _entry_3 [entry $BASE._entry_3 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::from" \
    ...
    variable _entry_4 [entry $BASE._entry_4 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::to" \
    ...
    variable _entry_5 [entry $BASE._entry_5 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::step" \
    ...
    variable _entry_6 [entry $BASE._entry_6 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::window_from" \
    ...
    variable _label_13 [label $BASE._label_13 \
	    -font {helvetica 10} \
	    -text "Ready" \
	    -textvariable "diffusion_coefficient::status"]
    ...
    variable _entry_7 [entry $BASE._entry_7 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::window_to" \
    ...
    variable _entry_8 [entry $BASE._entry_8 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::window_every" \
