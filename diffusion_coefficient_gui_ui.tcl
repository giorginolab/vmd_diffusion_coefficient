...
#
# UI generated by GUI Builder Build 146 on 2019-08-28 13:45:42 from:
...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    grid $BASE._checkbutton_3 -in $base._frame_1 -row 1 -column 3 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE.plot_msd_button -in $base._frame_2 -row 2 -column 3 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "nsew"
    grid $BASE.plot_d_button -in $base._frame_2 -row 2 -column 4 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE.reset_interval_button -in $base._frame_4 -row 1 -column 7 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE._label_7 -in $base._frame_2 -row 1 -column 3 \
	    -columnspan 2 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._label_17 -in $base._frame_2 -row 1 -column 1 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE.compute_d_button -in $base._frame_2 -row 2 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid rowconfigure $base._frame_2 1 -weight 0 -minsize 21 -pad 0
    grid rowconfigure $base._frame_2 2 -weight 1 -minsize 2 -pad 0
    grid columnconfigure $base._frame_2 1 -weight 0 -minsize 40 -pad 0
    grid columnconfigure $base._frame_2 2 -weight 0 -minsize 14 -pad 0
    grid columnconfigure $base._frame_2 3 -weight 1 -minsize 2 -pad 0
    grid columnconfigure $base._frame_2 4 -weight 1 -minsize 40 -pad 0
