...
#
# UI generated by GUI Builder Build 146 on 2019-08-28 14:48:16 from:
...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    variable _label_16 [label $BASE._label_16 \
	    -font {Helvetica 13} \
	    -text "Help"]
    variable _label_17 [label $BASE._label_17 \
	    -font {Helvetica 10} \
	    -justify "right" \
	    -text "Compute..."]
    variable compute_d_button [button $BASE.compute_d_button \
	    -command [namespace code [list compute_d_button_command]] \
	    -font {Helvetica 10 bold} \
	    -text "Diffusion coefficient from linear MSD fit"]
    ...
    grid $BASE._frame_1 -in $root -row 4 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "ew"
    grid $BASE._frame_2 -in $root -row 9 -column 1 \
	    -columnspan 2 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._frame_4 -in $root -row 6 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "news"
    grid $BASE._frame_6 -in $root -row 10 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._checkbutton_3 -in $base._frame_1 -row 1 -column 3 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE.plot_msd_button -in $base._frame_2 -row 2 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "nsew"
    grid $BASE.plot_d_button -in $base._frame_2 -row 2 -column 3 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._entry_6 -in $base._frame_4 -row 1 -column 1 \
	    ...
	    -rowspan 1 \
	    -sticky "ew"
    grid $BASE._label_13 -in $root -row 10 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE.reset_interval_button -in $base._frame_4 -row 1 -column 7 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE._label_7 -in $base._frame_2 -row 2 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._label_16 -in $base._frame_6 -row 1 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "w"
    grid $BASE._label_17 -in $base._frame_2 -row 1 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "e"
    grid $BASE.compute_d_button -in $base._frame_2 -row 1 -column 2 \
	    -columnspan 2 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid rowconfigure $root 8 -weight 1 -minsize 21 -pad 0
    grid rowconfigure $root 9 -weight 0 -minsize 23 -pad 0
    grid rowconfigure $root 10 -weight 1 -minsize 40 -pad 0
    ...
    grid rowconfigure $base._frame_2 1 -weight 1 -minsize 2 -pad 0
    grid rowconfigure $base._frame_2 2 -weight 1 -minsize 9 -pad 0
    grid columnconfigure $base._frame_2 1 -weight 0 -minsize 40 -pad 0
    grid columnconfigure $base._frame_2 2 -weight 1 -minsize 2 -pad 0
    grid columnconfigure $base._frame_2 3 -weight 1 -minsize 40 -pad 0
