...
#
# UI generated by GUI Builder Build 146 on 2012-12-14 17:06:37 from:
...
coefficients of a chosen molecular species."]
    ...
    variable button_help [Button $BASE.button_help \
	    -armcommand [namespace code [list button_help_armcommand]] \
	    -command [namespace code [list button_help_command]] \
	    -disarmcommand [namespace code [list button_help_disarmcommand]] \
    ...
    grid rowconfigure $root 2 -weight 1 -minsize 48 -pad 0
    ...
    grid rowconfigure $root 7 -weight 0 -minsize 3 -pad 0
    ...
    grid rowconfigure $base._frame_6 1 -weight 0 -minsize 18 -pad 0
