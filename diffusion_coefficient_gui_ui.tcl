...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    grid $BASE._frame_6 -in $root -row 11 -column 1 \
	    ...
	    -rowspan 1 \
	    -sticky "ew"
    grid $BASE._frame_5 -in $root -row 10 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE.reset_interval_button -in $base._frame_4 -row 1 -column 7 \
	    ...
	    -rowspan 1 \
	    -sticky ""
    grid $BASE._label_7 -in $root -row 10 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._label_16 -in $base._frame_6 -row 1 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "w"
    grid $BASE._label_17 -in $root -row 9 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "e"
    grid $BASE.compute_d_button -in $root -row 9 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid rowconfigure $root 9 -weight 0 -minsize 4 -pad 0
    grid rowconfigure $root 10 -weight 0 -minsize 2 -pad 0
    grid rowconfigure $root 11 -weight 1 -minsize 40 -pad 0
    ...
    grid columnconfigure $base._frame_5 2 -weight 1 -minsize 40 -pad 0
