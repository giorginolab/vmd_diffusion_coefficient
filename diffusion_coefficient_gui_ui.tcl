...
#
# UI generated by GUI Builder Build 146 on 2012-12-14 15:59:34 from:
...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    variable _label_2 [label $BASE._label_2 \
	    -font {helvetica 10} \
	    -text "Computes one, two or three-dimensional MSD-based diffusion
coefficients of a chosen molecular species."]
    ...
    variable _entry_6 [entry $BASE._entry_6 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::arg(window_from)" \
    ...
    variable _entry_7 [entry $BASE._entry_7 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::arg(window_to)" \
    ...
    variable _entry_8 [entry $BASE._entry_8 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient::arg(window_every)" \
