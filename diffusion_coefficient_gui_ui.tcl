...
#
# UI generated by GUI Builder Build 146 on 2019-09-18 20:24:19 from:
...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    variable _label_16 [label $BASE._label_16 \
	    -font {Helvetica 13} \
	    -text "Documentation"]
    variable stop_button [button $BASE.stop_button \
	    -bitmap "error" \
	    -command [namespace code [list stop_button_command]] \
	    -foreground "#ff0000" \
	    -state "disabled" \
	    -text "_button_6"]
    ...
    grid $BASE._label_16 -in $base._frame_6 -row 1 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "w"
    grid $BASE.stop_button -in $base._frame_5 -row 1 -column 4 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
