...
#
# UI generated by GUI Builder Build 146 on 2011-07-22 16:58:47 from:
#    /shared/toni/vmd-utils/vmd_diffusion_coefficient/diffusion_coefficient_gui.ui
...
proc diffusion_coefficient_gui::ui {root args} {
    ...
    variable _label_2 [label $BASE._label_2 \
	    -font {helvetica 10} \
	    -text "\u00A9 2011 Universitat Pompeu Fabra\nToni Giorgino - www.multiscalelab.org"]
    ...
    variable _entry_1 [entry $BASE._entry_1 \
	    ...
	    -textvariable "diffusion_coefficient_gui::selection" \
    ...
    variable _entry_4 [entry $BASE._entry_4 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient_gui::to" \
    ...
    variable _entry_5 [entry $BASE._entry_5 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient_gui::step" \
    ...
    variable _entry_6 [entry $BASE._entry_6 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient_gui::window_from" \
    ...
    variable _label_13 [label $BASE._label_13 \
	    -font {helvetica 10} \
	    -text "Ready" \
	    -textvariable "diffusion_coefficient_gui::status"]
    ...
    variable _entry_7 [entry $BASE._entry_7 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient_gui::window_to" \
    ...
    variable _entry_8 [entry $BASE._entry_8 \
	    ...
	    -justify "center" \
	    -textvariable "diffusion_coefficient_gui::window_every" \
    ...
    variable _checkbutton_4 [checkbutton $BASE._checkbutton_4 \
	    ...
	    -font {helvetica 10} \
	    -text "Remove COM drift" \
	    -variable "diffusion_coefficient_gui::remove_drift"]
    ...
    grid $BASE._frame_2 -in $root -row 9 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "news"
    grid $BASE._frame_3 -in $root -row 6 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "news"
    grid $BASE._frame_4 -in $root -row 7 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._entry_1 -in $root -row 3 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "ew"
    grid $BASE._label_4 -in $root -row 4 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "e"
    grid $BASE._entry_2 -in $root -row 4 -column 2 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
	    ...
	    -rowspan 1 \
	    -sticky "w"
    grid $BASE._label_5 -in $root -row 5 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE.plot_d_button -in $base._frame_2 -row 1 -column 2 \
	    ...
	    -rowspan 1 \
	    -sticky "nsew"
    grid $BASE._label_6 -in $root -row 6 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid $BASE._label_10 -in $base._frame_3 -row 1 -column 6 \
	    ...
	    -rowspan 1 \
	    -sticky "w"
    grid $BASE._label_11 -in $root -row 7 -column 1 \
	    -columnspan 1 \
	    -ipadx 0 \
	    -ipady 0 \
	    -padx 0 \
    ...
    grid rowconfigure $root 2 -weight 0 -minsize 48 -pad 0
    ...
    grid rowconfigure $base._frame_3 1 -weight 0 -minsize 22 -pad 0
    ...
    grid rowconfigure $base._frame_4 1 -weight 0 -minsize 3 -pad 0
